...
class AnnonceSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        // Real image files
        $imageFiles = [
            'annonces/african-grey-parrot.jpg',
            'annonces/canary.jpg',
            'annonces/budgies.jpg',
            'annonces/lovebirds.jpg',
            'annonces/cockatiel.jpg',
        ];
        ...
        for ($i = 0; $i < 15; $i++) {
            ...
            // Add 1-3 images from our real image files
            for ($j = 0; $j < rand(1, 3); $j++) {
                Image::create([
                    'chemin_image' => $imageFiles[rand(0, count($imageFiles) - 1)],
