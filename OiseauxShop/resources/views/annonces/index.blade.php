...
<div class="container">
    ...
    <div class="row">
        ...
        <div class="col-lg-9">
            ...
            <!-- Replace the image section in the announcement card with this: -->
            @if($annonce->images->count() > 0)
     <img src="{{ \App\Helpers\ImageHelper::getImageUrl($annonce->images->first()->chemin_image) }}" 
     class="card-img-top" alt="{{ $annonce->titre }}" 
